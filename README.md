...
Extends Base Walk with a 52-dim obs space (adds ball/target slots, filled with zeros during walk training). Use as a bridge before fine-tuning Kicking_Movement_Bica.
